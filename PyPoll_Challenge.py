...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > county_most_votes):
            ...
            county_largest_vote_percentage = county_vote_percentage

    # 7: Print the county with the largest turnout to the terminal.
    county_largest_turnout_summary = (
        f"-------------------------\n"
        f"County with the largest turnout: {county_largest_turnout}\n"
        f"Vote Count: {county_most_votes:,}\n"
        f"Percentage: {county_largest_vote_percentage:.1f}%\n"
        f"-------------------------\n")
